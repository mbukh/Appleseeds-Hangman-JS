...
const wordsOffline = ["absolute", "accomplishment", "affection", "artistry",
    ...
    "consciousness", "courageous", "delight", "dressy", "enjoyment",
    "entertaining", "entrepreneur", "excellence", "excited",
    ...
    "payday", "peaceful", "pizza", "polite", "prize", "project", "rejoice",
    "relaxation", "relaxing", "responsible",
    "sanitary", "shower", "sincerity", "skill", "skilled", "smile",
    "strength", "style", "successful", "sunny", "sunshine", "talented",
...
async function showWelcomeScreen() {
    ...
    figlet(msg,
        ...
        (err, text) => {
            msgLog(text, "color: #CC3333; font-size:10px; text-shadow: 2px 2px #000;");
        });
